            ...
            children: [
              ...
              Center(
                child: Column(
                  children: [
                    ...
                    Obx(
                      () => _caregiverWalletController.isLoading.value
                          ? const CircularProgressIndicator(
                              color: Colors.white,
                            )
                          : Text(
                              '\$${_caregiverWalletController.userBalance.value}',
              ...
              Padding(
                ...
                child: ElevatedButton(
                  onPressed: () {
                    Get.toNamed(AppRoutes.caregiverWithDrawScreen);
                  },
              ...
              Padding(
                ...
                child: ElevatedButton(
                  onPressed: () {
                    Get.toNamed(AppRoutes.caregiverWithdrawHIstoryScreen);
                  },
                  style: ElevatedButton.styleFrom(
                    backgroundColor: Colors.white.withOpacity(0.15),
                    minimumSize: const Size(double.infinity, 50),
              ...
              Expanded(
                child: Obx(
                  () {
                    ...
                    final vouchers =
                        _caregiverWalletController.walletInfo.value.vouchers;
                        ...
                        return Container(
                          ...
                          child: Row(
                            children: [
                              ...
                              Text(
                                TimeFormatHelper.formatDateString(voucher.date),
                                // voucher.date,
                                style: TextStyle(
                                  color: Colors.white.withOpacity(0.7),
                                  fontSize: 14,
