...
class ShiftDetailsNoScreen extends StatefulWidget {
  const ShiftDetailsNoScreen({super.key});

  @override
  State<ShiftDetailsNoScreen> createState() => _ShiftDetailsNoScreen();
}

class _ShiftDetailsNoScreen extends State<ShiftDetailsNoScreen> {
