...
class BorderlessCustomTextFieldEnabled extends StatefulWidget {
  ...
  final bool? isEmail;
  final bool? readOnly;
  final bool enabled; // Added this property to control editability

  const BorderlessCustomTextFieldEnabled({
    super.key,
  ...
  @override
  State<BorderlessCustomTextFieldEnabled> createState() =>
      _BorderlessCustomTextFieldEnabledState();
}

class _BorderlessCustomTextFieldEnabledState extends State<BorderlessCustomTextFieldEnabled> {
  ...
  Widget build(BuildContext context) {
    return TextFormField(
      ...
      enabled: widget.enabled, // Added the enabled property
